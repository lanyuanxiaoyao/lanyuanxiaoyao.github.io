...
[toc!?depth=5&direction=lr&title=Kafka学习路线&root=Kafka]
...
![点对点模式](https://www.github.com/lanyuanxiaoyao/GitGallery/raw/master/小书匠/2018/7/26/Kafka/1532586870942.png)
...
![发布/订阅模式](https://www.github.com/lanyuanxiaoyao/GitGallery/raw/master/小书匠/2018/7/26/Kafka/1532579933801.png)
...
![Kafka安装目录](https://www.github.com/lanyuanxiaoyao/GitGallery/raw/master/小书匠/2018/7/26/Kafka/1532579933781.png)

下面是Kafka安装文件目录的构成：
- **bin** Kafka相关操作的可执行脚本文件

![bin 目录](https://www.github.com/lanyuanxiaoyao/GitGallery/raw/master/小书匠/2018/7/26/Kafka/1532586870943.png)

- **config** Kafka相关配置文件

![config 目录](https://www.github.com/lanyuanxiaoyao/GitGallery/raw/master/小书匠/2018/7/26/Kafka/1532586870959.png)

- **data** Kafka数据存放目录，主要是日志（这个目录是我自己创建的，默认的安装目录里面没有，我在配置文件中指定了这个目录作为数据存放目录，实际上放哪里都行）
- **libs** Kafka的核心代码和相关引用的第三方库

![libs 目录](https://www.github.com/lanyuanxiaoyao/GitGallery/raw/master/小书匠/2018/7/26/Kafka/1532586870978.png)

- **logs** Kafka日志存放目录

![logs 目录](https://www.github.com/lanyuanxiaoyao/GitGallery/raw/master/小书匠/2018/7/26/Kafka/1532586870960.png)

- **site-docs** Kafka帮助文档

![site-docs 目录](https://www.github.com/lanyuanxiaoyao/GitGallery/raw/master/小书匠/2018/7/26/Kafka/1532586870961.png)
